                            ...
                            <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo02">
                                <ul class="nav justify-content-end">
                                    <li class="nav-item active" style="padding-top: 1.5rem;">
                                        <a href="/surat/ajukan" class="nav-link active" style="color:#0A5384"><h6 style="font-weight: bolder;">Ajukan Surat</h6></a>
                                    </li>
                                    <li class="nav-item" style="padding-top: 1.5rem;">
                                        <a href="/surat" class="nav-link active" style="color:#0A5384"><h6>Kumpulan Surat</h6></a>
                                    </li>
